...
@click.option("--epochs", help = "the number of training epochs", type = int, default = 100)
@click.option("--threshold", help = "the number of epochs with no loss update to stop training", type = int, default = 10)
